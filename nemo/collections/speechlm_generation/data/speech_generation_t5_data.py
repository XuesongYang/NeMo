...
class T5SpeechGenerationDataModule(pl.LightningDataModule, IOMixin):
    ...
    def _create_dataset(self, mode: str):
        ...
        if data_cfg.get("is_tarred", False):
            ...
            return build_virtual_prompt_dataset_from_config(
                config=data_cfg,
                ...
                english_only_model=self.english_only_model,
                context_conditioning=self.context_conditioning,
                use_beta_binomial_interpolator=self.use_beta_binomial_interpolator,
            )

        ...
        for logger in self.loggers:
            ...
            for idx, (pred_audio_np, target_audio_np, context_audio_np) in enumerate(
                ...
                if is_wandb:
                    ...
                    audio_list.append(wandb.Audio(pred_audio_np, sample_rate=self.sample_rate, caption="prediction"))
                    audio_list.append(wandb.Audio(target_audio_np, sample_rate=self.sample_rate, caption="target"))
